...
use super::vad::{ContinuousVadProcessor, VAD_DEFAULT_REDEMPTION_TIME_MS};
...
impl AudioPipeline {
    pub fn new(
        ...
        let vad_processor = match ContinuousVadProcessor::new(sample_rate, VAD_DEFAULT_REDEMPTION_TIME_MS) {
            Ok(processor) => {
