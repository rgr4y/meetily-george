    ...
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        <select
          ...
          className="w-full px-3 py-2 text-sm bg-input border border-input rounded-md shadow-sm text-foreground focus:outline-none focus:ring-1 focus:ring-primary focus:border-primary disabled:opacity-50 disabled:cursor-not-allowed"
        >
        ...
        {isParakeet && (
          <div className="p-2 bg-amber-50 dark:bg-amber-950 border border-amber-200 dark:border-amber-800 rounded text-amber-800 dark:text-amber-200">
        ...
        <div className="text-xs space-y-2 pt-2">
          <p className="text-muted-foreground">
            <strong className="text-foreground">Current:</strong> {selectedLanguageName}
          </p>
          {selectedLanguage === 'auto' && (
            <div className="p-2 bg-yellow-50 dark:bg-yellow-950 border border-yellow-200 dark:border-yellow-800 rounded text-yellow-800 dark:text-yellow-200">
          ...
          {selectedLanguage === 'auto-translate' && (
            <div className="p-2 bg-blue-50 dark:bg-blue-950 border border-blue-200 dark:border-blue-800 rounded text-blue-800 dark:text-blue-200">
          ...
          {selectedLanguage !== 'auto' && selectedLanguage !== 'auto-translate' && (
            <p className="text-muted-foreground">
              Transcription will be optimized for <strong className="text-foreground">{selectedLanguageName}</strong>
            </p>
          )}
        </div>
      </div>
