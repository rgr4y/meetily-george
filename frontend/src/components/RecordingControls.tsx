                    ...
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <button
                          ...
                          className={`w-12 h-12 flex items-center justify-center ${isStarting || isProcessing || isValidatingModel ? 'bg-muted-foreground/60' : 'bg-red-500 hover:bg-red-600'
                        ...
                        <TooltipTrigger asChild>
                          <button
                            ...
                            className={`w-10 h-10 flex items-center justify-center ${isPausing || isResuming || isStopping
                              ...
                              : 'bg-card border-2 border-border text-foreground hover:border-muted-foreground hover:bg-accent'
                      ...
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <button
                            ...
                            className={`w-10 h-10 flex items-center justify-center ${isStopping || isPausing || isResuming ? 'bg-muted-foreground/60' : 'bg-red-500 hover:bg-red-600'
                              } rounded-full text-white transition-colors relative`}
                          >
                            <Square size={16} />
                            {isStopping && (
